...
import com.arjun.twitterapp.BuildConfig;
...
public class ImageCache {
    ...
    private LruCache<String, Heroes> mMemoryCache;
     ...
     */
    private ImageCache(float memCacheSizePercent,Context context) {

        init(memCacheSizePercent,context);
    }
    ...
    public static ImageCache getInstance(
            FragmentManager fragmentManager, float memCacheSizePercent,Context context) {
...
// No existing ImageCache, create one and store it in RetainFragment
        ...
        if (imageCache == null) {
            ...
            imageCache = new ImageCache(memCacheSizePercent,context);
     ...
     * @param memCacheSizePercent The cache size as a percent of available app memory.
     */
    private void init(float memCacheSizePercent,Context context) {
...
// Set up memory cache
        ...
        mMemoryCache = new LruCache<String, Heroes>(memCacheSize) {
            /**
     ...
     */
    public void addBitmapToCache(String data, Heroes bitmap) {
...
// Add to memory cache
     ...
     */
    public Heroes getBitmapFromMemCache(String data) {
        if (mMemoryCache != null) {
            final Heroes memBitmap = mMemoryCache.get(data);
            if (memBitmap != null) {
                if (BuildConfig.DEBUG) {
